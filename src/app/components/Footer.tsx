  ...
  return (
    <div className="w-full h-[200px] mt-8 flex bg-slate-600 px-16 pt-8 pb-4 py-4">
      <div className="w-[25%] h-full  px-10 flex flex-col gap-2">
        ...
        <Link
          className="text-slate-400 font-normal text-[12px]  lg:text-[14px] md:text-[12px] xl:text-[14px] 2xl:text-[14px] hover:text-white"
          href="/"
        >
          Home
        </Link>
      ...
      <div className="w-[35%] h-full px-10">
        <h2 className="text-white font-bold text-[12px] lg:text-[14px] md:text-[12px] xl:text-[14px] 2xl:text-[18px]">
          Social Media
        </h2>
